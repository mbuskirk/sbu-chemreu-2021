...
c!!!!!!
      ...
      subroutine drwstr(ixp,iyp,str,nstr,ind)
      implicit double precision (a-h,o-z)
      character*2 str
      stop
      end
      subroutine drwqstr(ixp,iyp,ian,q,ind)
      implicit double precision (a-h,o-z)
      stop
      end
      ...
      subroutine drwpol(iarray,i1,i2,i3,i4,i5)
      integer*2 iarray(8)
      stop
      end
      subroutine gtht(i,ires)
      implicit double precision (a-h,o-z), integer (i-n)
      stop
      end
      subroutine gethet(i,n,str)
      implicit double precision (a-h,o-z), integer (i-n)
      character str*(*)
      stop
      end
...
c      call espgrdd(npts1,npts2,npts3,idebug,denn,p)
     ...
     &                hd(6,maxorb)
      ...
      common /dynhlp/ qd(maxorb*maxorb),pd(maxorb),gd(3,maxorb),
     &                hd(6,maxorb)
      common /elfhlp/ phi(maxorb),dphi(3,maxorb),
     ...
     &            p,paa,pd,gd,hd,
     &            phi,dphi,dxpsi,dypsi,dzpsi,
     &            vectrs,vectrb,focc,focb)

      return
      end

      subroutine exxtop(npr,norbs)
      implicit double precision (a-h,o-z), integer (i-n)
      parameter (maxorb=256)
      common /vectrs/ vectrs(maxorb*maxorb),focc(maxorb),nocc,ncols
      common /vectrb/ vectrb(maxorb*maxorb),focb(maxorb),nocb,ncolb
      ...
      call exxtod(npr,norbs,vectrs,vectrb,focc,focb,eiga,eigb)
     ...
     &               ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      subroutine calgas(iasel,iprnt,istat)
      implicit double precision (a-h,o-z), integer (i-n)
      parameter (numat1=20000)
      parameter (mxcon=10)
      common /atcom/ coo(3,numat1),rzp(numat1),ianz(numat1),
     ...
     &               ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      call calgad(iasel,iprnt,istat,qat,ianz,iconn,iresid,ityp)
     ...
     &               ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      call getmod(igetmo,iadd,coo,qat,ianz,iaton,iconn,iresid)
     ...
     &           inat,lab,labhet,xv,yv,icalf,ncalf,icxp,icyp,
     &           scal,scali)
     ...
     &              ishoh,ision,achain(numcal)
      ...
      call reslad(rzp,ixp,iyp,
     &            icalf,nchain,iamino,reson,irsnr,lab,ihet,
     &            achain,ncalf,scali)
     ...
     &               ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      subroutine hcoord(ioatms,nstrt,iaddh)
      implicit double precision (a-h,o-z), integer (i-n)
      parameter (numat1=20000)
      parameter (mxcon=10)
      common /atcom/ coo(3,numat1),rzp(numat1),ianz(numat1),
     ...
     &              ishoh,ision,achain(numcal)
      ...
      call hcoodd(istat,ioatms,nstrt,iaddh,ipdbt,coo,ianz,iaton,iresid,
     &            iconn,icalf,ncalf,ianf,islu,nchain,iamino)
     ...
     &               ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      subroutine allon(ntota,nwat,nion,nsign,newat,nresi)
      implicit double precision (a-h,o-z), integer (i-n)
      parameter (numat1=20000)
      parameter (mxcon=10)
      common /atcom/ coo(3,numat1),rzp(numat1),ianz(numat1),
...
c     &                ir(3,3,192),it(3,192),rdum(12)
     ...
     &            issdon,iclon,ichx,ishoh,ision,nspg,
     &            nat,norg,xa,ya,yb,za,zb,zc,a,b,c,alpha,beta,gamma)
      ...
      subroutine tnkfst(igttnk,idebug,ialloc)
      implicit double precision (a-h,o-z), integer (i-n)
      parameter (numat1=20000)
      parameter (mxcon=10)
      common /atcom/ coo(3,numat1),rzp(numat1),ianz(numat1),
     ...
     &                xa,ya,yb,za,zb,zc,a,b,c,alpha,beta,gamma
      ...
      call tnkfsd(igttnk,idebug,ialloc,
     &            coo,ianz,iatclr,iconn,lring,
     &            ichx,nat,norg,
     &            xa,ya,yb,za,zb,zc,a,b,c,alpha,beta,gamma)
      if (igttnk.eq.-1) igttnk = 0
     ...
     &            ihet,iclhet,reson,lab,labhet,iclset,ligcat,
     &            iams,ihets,irsnr,
     ...
     &                ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      call chkbcd(ncalf,ihet,reson,iaton,iatclr,ision)
     ...
     &              ishoh,ision,achain(numcal)
      ...
      call acttad(iop1,iop2,iop3,ihet,ision)
     ...
     &                ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      subroutine opthyd(lflp,lhis,lres,lwat)
      implicit double precision (a-h,o-z)
      parameter (numat1=20000)
      parameter (mxcon=10)
      common /atcom/  coo(3,numat1),rzp(numat1),ianz(numat1),
     ...
     &              ishoh,ision,achain(numcal)
      ...
      call opthdd(lflp,lhis,lres,lwat,
     &            iupres,nupres,irsnr,
     ...
     &                ixp(numat1),iyp(numat1),iconn(mxcon+1,numat1)
      ...
      subroutine nxtlin(str,istat)
      implicit double precision (a-h,o-z)
      character str*(*)
      
      call nxline(str,istat)

      return
      end

      subroutine redel(str,n)
      implicit double precision (a-h,o-z)
      character str*(*)
      ...
      subroutine prsgmf(iopt)
      implicit double precision (a-h,o-z)
      parameter (maxmol=100)
      common /mfdatah/ mollin(maxmol)
      
      call prsqmd(iopt,mollin)
